...
filename=r'C:\Users\Axios丶LC\Desktop\export\人员导入模板 --新增100W.xlsx'
...
startValues=['0000001','1000001','1000001','1000001','1000001','1000001']
# 初始值对应的列
col=['A','B','C','E','F','H']
indexs = ['A','B','C','D','E','F','G','H','I','J','K','L','M','N','O','P','Q']
#先将表头写入文件
