...
def getRGB(box):
    img = screenshot(box)
    saveTempPic(img,'resources/posturetemp/',False)
    r, g, b = img.pixel(3, 3)
    print("r:",r,"g:",g,"b:",b)
...
def screen(gun_pos):
    ...
    while True:
        ...
        #arr = extract_gun(arr)
        saveTempPic(img,'resources/temp2313/',False)
...
def initialize(img_dir):
    ...
    with open(r'resources//dict//gun_dict.json', 'r') as f:
        gun_dict = json.load(f)
    
    global gun_list_name
    with open(r'resources//dict//gun_arr.json', 'r') as f:
